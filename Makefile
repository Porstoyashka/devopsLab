...
PRE_UNINSTALL = :
POST_UNINSTALL = :
bin_PROGRAMS = program$(EXEEXT) test_FuncA$(EXEEXT)
...
am_program_OBJECTS = main.$(OBJEXT) HTTP_Server.$(OBJEXT) \
	FuncA.$(OBJEXT)
...
am__depfiles_remade = ./$(DEPDIR)/FuncA.Po ./$(DEPDIR)/HTTP_Server.Po \
	./$(DEPDIR)/main.Po ./$(DEPDIR)/test_FuncA.Po
am__mv = mv -f
...
ACLOCAL = ${SHELL} '/home/rpjc/Documents/maxKostenko/devopsLab/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/rpjc/Documents/maxKostenko/devopsLab/missing' autoconf
...
CXXFLAGS = -g -O2
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"program\" -DPACKAGE_TARNAME=\"program\" -DPACKAGE_VERSION=\"1.0\" -DPACKAGE_STRING=\"program\ 1.0\" -DPACKAGE_BUGREPORT=\"maksym33kostenko@gmail.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"program\" -DVERSION=\"1.0\" -DHAVE_LIBPTHREAD=1
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LIBS = -lpthread 
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/home/rpjc/Documents/maxKostenko/devopsLab/missing' makeinfo
MKDIR_P = /usr/bin/mkdir -p
OBJEXT = o
PACKAGE = program
PACKAGE_BUGREPORT = maksym33kostenko@gmail.com
...
STRIP = 
VERSION = 1.0
abs_builddir = /home/rpjc/Documents/maxKostenko/devopsLab
abs_srcdir = /home/rpjc/Documents/maxKostenko/devopsLab
abs_top_builddir = /home/rpjc/Documents/maxKostenko/devopsLab
abs_top_srcdir = /home/rpjc/Documents/maxKostenko/devopsLab
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
program_SOURCES = main.cpp HTTP_Server.cpp FuncA.cpp
test_FuncA_SOURCES = test_FuncA.cpp FuncA.cpp

# Add necessary system libraries for socket operations
program_LDADD = -lpthread
all: all-am
